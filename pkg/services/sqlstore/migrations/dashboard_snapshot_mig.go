...
func addDashboardSnapshotMigrations(mg *Migrator) {
	...
	mg.AddMigration("alter dashboard_snapshot to mediumtext v2", NewRawSQLMigration("").
		Mysql("ALTER TABLE dashboard_snapshot MODIFY dashboard MEDIUMTEXT;").OceanBase("ALTER TABLE dashboard_snapshot MODIFY dashboard MEDIUMTEXT;"))
	...
	mg.AddMigration("Change dashboard_encrypted column to MEDIUMBLOB", NewRawSQLMigration("").
		Mysql("ALTER TABLE dashboard_snapshot MODIFY dashboard_encrypted MEDIUMBLOB;").OceanBase("ALTER TABLE dashboard_snapshot MODIFY dashboard_encrypted MEDIUMBLOB;"))
}
